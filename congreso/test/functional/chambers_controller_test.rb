...
class ChambersControllerTest < ActionController::TestCase
  ...
  test "should create chamber" do
    assert_difference('Chamber.count') do
      post :create, chamber: { name: @chamber.name, photo_medium: @chamber.photo_medium, photo_small: @chamber.photo_small }
    end
  ...
  test "should update chamber" do
    put :update, id: @chamber, chamber: { name: @chamber.name, photo_medium: @chamber.photo_medium, photo_small: @chamber.photo_small }
    assert_redirected_to chamber_path(assigns(:chamber))
  end
